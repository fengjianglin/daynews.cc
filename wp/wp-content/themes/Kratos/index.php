		...
		<div class="row">
			...
			<?php if ( kratos_option( 'show_head_cat' ) ) : ?>
				<div class="kratos-hentry clearfix">
					<h1 class="kratos-post-header-title"><a href="/">首頁</a> > 分類 > <?php echo single_cat_title('', false); ?></h1>
			...
			<?php if ( kratos_option( 'show_head_tag' ) ) : ?>
				<div class="kratos-hentry clearfix">
					<h1 class="kratos-post-header-title"><a href="/">首頁</a> > 標籤 > <?php echo single_cat_title('', false); ?></h1>
					<h1 class="kratos-post-header-title"><?php echo category_description(); ?></h1>
				</div>
			<?php endif; ?>	
			...
			?>
				<div class="kratos-hentry clearfix">
					<h1 class="kratos-post-header-title"><a href="/">首頁</a> > 歸檔 > <?php echo the_archive_title('', false); ?></h1>
				</div>
			<?php
				}elseif(is_search()){
			?>
