...
<div class="kratos-post-inner">
	<header class="kratos-entry-header clearfix">
		...
		<div class="kratos-post-meta">
			...
			<a href="<?php the_permalink() ?>"><i class="fa fa-thumbs-o-up"></i> <?php if( get_post_meta($post->ID,'love',true) ){ echo get_post_meta($post->ID,'love',true); } else { echo '0'; }?>人點贊</a>
			</span>
		</div>
	</header>
...
<div class="kratos-entry-border-new clearfix">
	...
	<div class="kratos-post-meta-new">
		...
		<span class="pull-right">
			<a class="read-more" href="<?php the_permalink() ?>" title="阅读全文">閱讀全文 <i class="fa fa-chevron-circle-right"></i></a>
		</span>
	</div>
</div>
<?php } ?>
